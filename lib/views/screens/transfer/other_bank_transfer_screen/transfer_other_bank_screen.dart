...
import 'package:viser_bank/views/screens/transfer/other_bank_transfer_screen/widget/other_bank_list_item.dart';
...
class _TransferOtherBankScreenState extends State<TransferOtherBankScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: GetBuilder<OtherBankTransferController>(builder: (controller)=>Scaffold(
