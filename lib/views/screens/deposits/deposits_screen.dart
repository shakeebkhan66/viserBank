      ...
      builder: (controller) => WillPopWidget(
        ...
        child: SafeArea(
          child: Scaffold(
            ...
            // appBar: AppBar(
            //   title: Text(MyStrings.deposits.tr, style: interRegularLarge.copyWith(color: MyColor.colorWhite)),
            ...
            body: controller.isLoading ? const CustomLoader() : Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: controller.depositList.isEmpty && controller.searchLoading == false ? NoDataFoundScreen(title:MyStrings.noDepositFound.tr,height:controller.isSearch?0.75:0.8) :
