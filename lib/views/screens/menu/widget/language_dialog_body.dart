    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(child: Text(MyStrings.selectALanguage.tr,style: interRegularDefault.copyWith(color: Colors.black, fontSize: Dimensions.fontLarge, fontWeight: FontWeight.w600),),),
