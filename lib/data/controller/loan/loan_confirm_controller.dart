...
class LoanConfirmController extends GetxController {
  ...
  loadData(LoanPreviewResponseModel model) async {
    ...
    chargeText = '${MyStrings.ifAnInstallmentIsDelayedFor} ${model.data?.plan?.delayValue} ${MyStrings.orMoreDaysThen} $currencySymbol${'3.33'} ${MyStrings.willBeAppliedForEachDay}'.tr;
