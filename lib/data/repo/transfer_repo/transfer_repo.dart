...
class TransferRepo{
  ...
  Future<dynamic> myBankTransferRequest({
      amount, authMode,account,
    name
}
      ) async {
   // String url = '${UrlContainer.baseUrl}${UrlContainer.myBankTransferUrl}$id';
    String url = '${UrlContainer.baseUrl}own/transfer/sendKmoney';
    print(url);
   // Map<String, dynamic>params = {'amount': amount.toString()};
    Map<String, dynamic>params = {'username':name,
      'amount': amount,
