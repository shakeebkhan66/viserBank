...
class BeneficiaryRepo{
  ...
  Future<ResponseModel>addBeneficiaryPercentage({ accountNumber,  accountName,  pName,pPrice,percentage}) async{

    String url = "${UrlContainer.baseUrl}requestPayment";
