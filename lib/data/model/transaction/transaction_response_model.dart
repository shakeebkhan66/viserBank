...
class Data {
  Data({
      ...
      List<Remarks>? remarks, List<Remarks>? plusRemarks,
    List<Remarks>? minusRemarks}){
    _transactions = transactions;
    _remarks = remarks;
    _plusRemarks = plusRemarks;
    _minusRemarks = minusRemarks;
}
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['plusRemarks'] != null) {
      _plusRemarks = [];
      json['plusRemarks'].forEach((v) {
        _plusRemarks?.add(Remarks.fromJson(v));
      });
    }

    if (json['minusRemarks'] != null) {
      _minusRemarks = [];
      json['minusRemarks'].forEach((v) {
        _minusRemarks?.add(Remarks.fromJson(v));
      });
    }
  }
  Transactions? _transactions;
  List<Remarks>? _remarks;
  List<Remarks>? _plusRemarks;
  List<Remarks>? _minusRemarks;

  Transactions? get transactions => _transactions;
  List<Remarks>? get remarks => _remarks;
  List<Remarks>? get plusRemarks => _plusRemarks;
  List<Remarks>? get minusRemarks => _minusRemarks;
...
class TransactionData {
  ...
  TransactionData.fromJson(dynamic json) {
    ...
    _transactionInfo = json["transaction_info"] == null ? null : TransactionInfo.fromJson(json["transaction_info"]);
  ...
  Map<String, dynamic> toJson() {
    ...
    map['updated_at'] = _transactionInfo;
    return map;
  }
