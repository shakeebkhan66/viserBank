...
class MyStrings{
  ...
  static const String signUpSologan = "                 To create an account,\nplease enter your valid information below";
  static const String signUpSologanNew = "                 Per creare un account,\ninserisci le tue informazioni valide qui sotto";
  ...
  static const String newDepositScreen = "KyCard";
  static  String enterAmount = "Enter amount";
  static  String kyReceived = "Ky Received";
  ...
  static const String paymentRequest = "Richiesta di pagamento";
  ...
  static const String transferWithinViserBank = "Transfer within kosmomoney";
  ...
  static const String  Success = 'Success';
  static const String  successMessage = 'Payment request created successfully';
  static const String  transectionType = 'Select an Transaction Type';
  static const String   remarks = 'Select an Remarks';
  static const String   balanceAdd = 'Balance Add';
  static const String   walletAdd = 'Wallet Add';
  static const String   walletSub = 'Wallet Subtract';
  static const String   ownBankTransfer = 'Own Bank Transfer';
  static const String   receivedMoney = 'Receveid Money';
  static const String   selectOone = 'select one';
  static List<LanguageModel> languages = [

    LanguageModel(imageUrl: '', languageName: 'Italic', countryCode: 'IT', languageCode: 'it'),
